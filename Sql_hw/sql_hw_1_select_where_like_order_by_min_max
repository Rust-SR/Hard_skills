...
select * from 
students where created_on = '2021-07-12 00:00:00' and name like '%Andrey%';
...
select * from students 
where created_on = ' 2020-10-03 00:00:00' or created_on = '2021-05-19 00:00:00' 
...
from students  order by created_on;
